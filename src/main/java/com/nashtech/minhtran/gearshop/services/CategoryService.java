...
public interface CategoryService {
    Page<CategoryDTO> getAllCategory(Optional<Integer> page, Optional<Integer> size, Optional<String> sort, Optional<String> direction, Optional<String> name);
    MessageResponse addNewCategory (@Valid CategoryRequest categoryRequest);
    MessageResponse updateCategory (int id, @Valid CategoryRequest categoryRequest);
